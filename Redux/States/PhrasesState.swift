...
//  Redux
//
//  Created by  ohayoukenchan on 2020/07/09.
...
// MARK: - State
///////////////////////////////////////////////s///////////////////////////////////////////
public struct PhrasesState: ReSwift.StateType, HasDisposeBag, HasDataSourceElements {
    public typealias ThisState = PhrasesState
    public typealias Response = API.Response<[Phrase]>//GitHubAPI.PublicRepo]>
...
extension PhrasesState {
    ...
    static func createDataSourceElements(
        ...
        ds.append(TitleElement("┗ PhrasesViewController"))
